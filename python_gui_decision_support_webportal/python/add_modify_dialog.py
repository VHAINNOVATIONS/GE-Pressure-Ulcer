...
########################################################################
class AddModifyDialog(wx.Dialog):
    """
    This class implements a generic modal dialog to add and modify database records.
    ...
    def __init__(self, controller, obj, row=None, title="Add", addRecord=True):
        """
    ...
    def onAdd(self):
        ...
        """
        data = self.getData()
        print "AddModifyDialog.onAdd...data"
        pprint(data)
