...
########################################################################
class AddModifyAlgorithmDefaultsDialog(wx.Dialog):
    """
    ...
    def __init__(self, controller, obj, db, row=None, title="Add", addRecord=True, algorithmId=None):
        ...
        """
        wx.Dialog.__init__(self, None, title="%s AlgorithmDefaults Record" % title)
    ...
    def getData(self):
        ...
        """
        data = {}
        data['algorithm_id'] = self.objInstance.algorithm_id
        for i in range(len(self.objInstance.editCols)):
    ...
    def onAdd(self):
        ...
        """
        data = self.getData()
        # print "AddModifyAlgorithmDefaultsDialog.onAdd - data = "
        # pprint(data)
