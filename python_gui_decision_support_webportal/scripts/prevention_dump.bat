...
set FILENAME=prevention_db_dump_%logtimestamp%.sql
"%MYSQL_HOME%\bin\mysqldump.exe" --user=root --password=%mysqlpass% --result-file=%basedir%\%FILENAME% --skip-extended-insert --complete-insert --verbose va_pupc patient_identification patient_turning prevention_session prevention_clinical_data
