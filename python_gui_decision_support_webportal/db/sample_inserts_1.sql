...
insert into `va_pupc`.`system_configuration` (`parameter_name`, `parameter_value`) VALUES ('THERMAL_CAMERA_SERVER_PATH','C:/Program Files (x86)/MICRO-EPSILON Messtechnik GmbH u Co KG/TIM Connect/Imager.exe');
...
INSERT INTO `va_pupc`.`algorithm_defaults` (`algorithm_id`,`parameter_name`,`default_value`) VALUES (3,'numberReps','24');
...
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (1, 'vid::pu_prevention_source_process::oni_filename', 'C:/pressure_ulcer/dump/test.oni');
...
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (1, 'gevxl::pressure_ulcer::prevention::pu_prevention_videoarchive_writer_process::depth_img_seq_root_folder', 'C:/pressure_ulcer/prevention');
...
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (3, 'vid::pu_assessment_rgbd_cam_source_process::file_storage_directory', 'C:/pressure_ulcer/assessment/assessment_rgbd');
...
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (3, 'vid::pu_assessment_thermal_cam_source_process::color_palette_filepath', 'C:/pressure_ulcer/resource/Rainbow240RGB.dat');

INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (3, 'vid::pu_assessment_thermal_cam_source_process::file_storage_directory', 'C:/pressure_ulcer/assessment/assessment_thermal');
...
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (3, 'vid::pu_assessment_hyperspectral_cam_source_process::file_storage_directory', 'C:/pressure_ulcer/assessment/assessment_hyperspectral');
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (3, 'vid::pu_assessment_hyperspectral_cam_source_process::white_ref_folder', 'C:/pressure_ulcer/resource/WhiteRefDarkBkg/12-24-59RES2048_EXP0030_BIT08-White');
INSERT INTO `va_pupc`.`experiment_configuration` (`experiment_id`, `parameter_name`, `parameter_value`) VALUES (3, 'vid::pu_assessment_hyperspectral_cam_source_process::dark_bkg_folder', 'C:/pressure_ulcer/resource/WhiteRefDarkBkg/12-26-37RES2048_EXP0030_BIT08-Dark');
