...
#include <pressure_ulcer/prevention/pu_prv_motion_demo_chain_process.h>
...
public:
  ...
  void set_proc(pu_prv_motion_demo_chain_process *p) { proc_ = p; }

  void on_configure(wxCommandEvent &evt);

private:

  pu_prv_motion_demo_chain_process *proc_;
...
public:
  ...
  void set_process(pu_prv_motion_demo_chain_process *p) { proc_ = p; } 
...
bool MyApp::OnInit()
{  
  vul_arg<vcl_string> a_config_file( "-c", "Config file", "C:/GEVXL/gevxl/projects/security/pressure_ulcer/prevention/pu_prv_motion_demo.tconf" );
