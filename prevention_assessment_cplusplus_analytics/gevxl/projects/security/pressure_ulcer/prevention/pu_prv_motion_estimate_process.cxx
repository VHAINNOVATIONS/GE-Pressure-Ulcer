...
bool pu_prv_motion_estimate_process::step( const vil_image_view<vxl_byte> &depth_byte_img ) 
{
...
vil_image_view<vxl_byte> compute_diff_image( 
  const vil_image_view<vxl_byte> & img_1,
...
vil_image_view<vxl_byte> colorize_flow(
