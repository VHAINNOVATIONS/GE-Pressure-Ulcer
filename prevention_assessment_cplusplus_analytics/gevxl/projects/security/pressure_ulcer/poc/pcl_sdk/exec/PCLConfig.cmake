...
macro(find_VTK)
  ...
  if (VTK_FOUND AND NOT ANDROID)
	...
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkCommon-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkCommon.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkRendering-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkRendering.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkHybrid-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkHybrid.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkCharts-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkCharts.lib)
	
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtksys-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtksys.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkVolumeRendering-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkVolumeRendering.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkViews-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkViews.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkIO-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkIO.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkInfovis-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkInfovis.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkImaging-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkImaging.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkGraphics-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkGraphics.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkGeovis-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkGeovis.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkGenericFiltering-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkGenericFiltering.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkFiltering-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkFiltering.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/vtkalglib-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/vtkalglib.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} debug ${VTK_DIR}/MapReduceMPI-gd.lib)
	set(VTK_LIBRARIES ${VTK_LIBRARIES} optimized ${VTK_DIR}/MapReduceMPI.lib)
