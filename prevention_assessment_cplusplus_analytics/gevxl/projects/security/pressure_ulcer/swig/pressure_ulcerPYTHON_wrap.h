...
#ifndef SWIG_pressure_ulcer_WRAP_H_
#define SWIG_pressure_ulcer_WRAP_H_
...
bool pthread_equal(DWORD ThreadId1, DWORD ThreadId2) 
{
  if(ThreadId1 == ThreadId2) return true;
  else return false;
}
# else
#  include <pthread.h>
...
class SwigDirector_pu_prevention_database_writer : public gevxl::pressure_ulcer::prevention::pu_prevention_database_writer, public Swig::Director {

public:
    SwigDirector_pu_prevention_database_writer(PyObject *self);
    virtual ~SwigDirector_pu_prevention_database_writer();
    virtual void write(bool const provider_present_flag, std::string const final_position);
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (method == NULL) {
          std::string msg = "Method in class pu_prevention_database_writer doesn't exist, undefined ";
          msg += method_name;
